...
alias test-performance="python run_tests.py performance"
alias test-coverage="python run_tests.py coverage"

# Environment validation
alias test-validate="python run_tests.py validate"
alias test-summary="python run_tests.py summary"
...
test-data-sample() {
    python -c "
from conftest import generate_sample_data
import pandas as pd
