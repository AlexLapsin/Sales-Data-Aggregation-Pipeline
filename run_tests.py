...
class TestRunner:
    ...
    def __init__(self):
        ...
        self.test_categories = {
            ...
            "kafka": {
                "file": "test_kafka_streaming.py",
                "description": "Kafka streaming functionality",
                "prerequisites": ["kafka_running"],
                "estimated_time": "5-7 minutes",
            },
            "transform": {
                "file": "test_transform.py",
                "description": "ETL data transformation logic",
                "prerequisites": ["env_file"],
